...
<head>
    ...
    <link rel="stylesheet" href="${ctx}/static/layui_css/adjustment.css">
</head>
<body>
<form action="">
    ...
    <div class="layui-collapse sy-layui-collapse" lay-filter="test">
    ...
    <div class="layui-form-item">
        <div class="layui-input-block sy-layui-input-block">
